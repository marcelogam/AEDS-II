...
public class TabelaHashRes {
    ...
    // Contrutor da lista
    public TabelaHashRes(int tamanho) {
        this.array = new TabelaHashRes[tamanho];
        this.n = 0;
    }

    // Construtor
    public TabelaHashRes() {
        this.app_id = 0;
        this.name = "";
    ...
    public TabelaHashRes(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, TabelaHashRes jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, TabelaHashRes jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, TabelaHashRes jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public static int descobrirIdGame(String str, int cont, TabelaHashRes jogos[]) {
        int id = 0;
    ...
    public void inserirFim(TabelaHashRes game) throws Exception {
    ...
    private static int valorDaString(String s) {
        int valor = 0 ;
    ...
    public static void main(String[] args) throws Exception {
        ...
        long end;
        BufferedWriter arq = new BufferedWriter(new FileWriter("matrícula_hashReserva.txt"));
        ...
        TabelaHashRes jogos[] = new TabelaHashRes[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new TabelaHashRes();
        ...
        while (!isFim(val[cont])) {
            ...
            int num = valorDaString(jogos[j].getName());
            tabela.inserir(num);
            cont++;
        }
        ...
        while (!isFim(entrada[i])) {
            ...
            int id = valorDaString(entrada[i]);
            tabela.pesquisar(id);
            i++;
            entrada[i] = sc.nextLine();
        }

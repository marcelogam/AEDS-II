...
public class TabelaHashLista {
    ...
    public TabelaHashLista(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, TabelaHashLista jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, TabelaHashLista jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, TabelaHashLista jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public static int descobrirIdGame(String str, int cont, TabelaHashLista jogos[]) {
        int id = 0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        TabelaHashLista jogos[] = new TabelaHashLista[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new TabelaHashLista();
            jogos[i].read(line, jogos, i);
            line = br.readLine();
            i++;
        }

        // Ler da entrada padraonull
        i = 0;

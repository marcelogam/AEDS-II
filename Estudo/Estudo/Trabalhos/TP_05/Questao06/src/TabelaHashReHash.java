...
public class TabelaHashReHash {
    ...
    public TabelaHashReHash(int tamanho) {
        this.array = new TabelaHashReHash[tamanho];
        this.n = 0;
    }
    ...
    public TabelaHashReHash(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, TabelaHashReHash jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, TabelaHashReHash jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, TabelaHashReHash jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public static int descobrirIdGame(String str, int cont, TabelaHashReHash jogos[]) {
        int id = 0;
    ...
    public void inserirFim(TabelaHashReHash game) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TabelaHashReHash jogos[] = new TabelaHashReHash[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new TabelaHashReHash();

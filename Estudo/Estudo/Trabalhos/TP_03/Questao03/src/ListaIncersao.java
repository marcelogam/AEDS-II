...
public class ListaIncersao {
    ...
    // Contrutor da lista
    public ListaIncersao(int tamanho) {
        this.array = new ListaIncersao[tamanho];
        this.n = 0;
    }

    // Construtor
    public ListaIncersao() {
        this.app_id = 0;
        this.name = "";
    ...
    public ListaIncersao(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, ListaIncersao jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, ListaIncersao jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, ListaIncersao jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public void inserirInicio(ListaIncersao game) throws Exception {
    ...
    public void inserirFim(ListaIncersao game) throws Exception {
    ...
    public void inserir(ListaIncersao game, int pos) throws Exception {
    ...
    public ListaIncersao removerInicio() throws Exception {
    ...
    public ListaIncersao removerFim() throws Exception {
    ...
    public ListaIncersao remover(int pos) throws Exception {
    ...
    public ListaIncersao descobrirJogo(int id, ListaIncersao jogos[], int contJogos) {
        ListaIncersao game = new ListaIncersao();
    ...
    public void sort() {
        ...
        for (int i = 1; i < n; i++) {
            game = array[i];
            int j = i - 1;
            while ((j >= 0) && (array[j].getApp_id() > game.getApp_id())) {
                array[j + 1] = array[j];
                j--;
            }
            array[j + 1] = game ;
    ...
    public static void main(String[] args) throws Exception {
        ...
        ListaIncersao jogos[] = new ListaIncersao[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new ListaIncersao();
        ...
        ListaIncersao list = new ListaIncersao(i);
        for (int j = 0; j < i; j++) {
            for (int l = 0; l < contJogos; l++) {

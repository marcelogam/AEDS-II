...
public class ListaHeapSort {
    ...
    // Contrutor da lista
    public ListaHeapSort(int tamanho) {
        this.array = new ListaHeapSort[tamanho];
        this.n = 0;
    }

    // Construtor
    public ListaHeapSort() {
        this.app_id = 0;
        this.name = "";
    ...
    public ListaHeapSort(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, ListaHeapSort jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, ListaHeapSort jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, ListaHeapSort jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public void inserirInicio(ListaHeapSort game) throws Exception {
    ...
    public void inserirFim(ListaHeapSort game) throws Exception {
    ...
    public void inserir(ListaHeapSort game, int pos) throws Exception {
    ...
    public ListaHeapSort removerInicio() throws Exception {
    ...
    public ListaHeapSort removerFim() throws Exception {
    ...
    public ListaHeapSort remover(int pos) throws Exception {
    ...
    public ListaHeapSort descobrirJogo(int id, ListaHeapSort jogos[], int contJogos) {
        ListaHeapSort game = new ListaHeapSort();
    ...
    public void sort() {
        ...
        ListaHeapSort[] tmp = new ListaHeapSort[n + 1];
        for (int i = 0; i < n; i++) {
            tmp[i + 1] = array[i];
        }
        array = tmp;
    ...
    public void reconstruir(int tamHeap) {
        ...
        while (i <= (tamHeap / 2)) {
            ...
            if (array[filho].getRelease_date().compareTo(array[i].getRelease_date()) > 0) {
                swap(i, filho);
                i = filho;
            } else {
                i = tamHeap;
    ...
    public static void main(String[] args) throws Exception {
        ...
        ListaHeapSort jogos[] = new ListaHeapSort[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new ListaHeapSort();
        ...
        ListaHeapSort list = new ListaHeapSort(i);
        for (int j = 0; j < i; j++) {
            for (int l = 0; l < contJogos; l++) {

...
public class ListaBolha {
    ...
    // Contrutor da lista
    public ListaBolha(int tamanho) {
        this.array = new ListaBolha[tamanho];
        this.n = 0;
    }
    ...
    public ListaBolha(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, ListaBolha jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, ListaBolha jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, ListaBolha jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public void inserirInicio(ListaBolha game) throws Exception {
    ...
    public void inserirFim(ListaBolha game) throws Exception {
    ...
    public void inserir(ListaBolha game, int pos) throws Exception {
    ...
    public ListaBolha removerInicio() throws Exception {
    ...
    public ListaBolha removerFim() throws Exception {
    ...
    public ListaBolha remover(int pos) throws Exception {
    ...
    public ListaBolha descobrirJogo(int id, ListaBolha jogos[], int contJogos) {
        ListaBolha game = new ListaBolha();
    ...
    public static void main(String[] args) throws Exception {
        ...
        ListaBolha jogos[] = new ListaBolha[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new ListaBolha();
        ...
        ListaBolha list = new ListaBolha(i);
        for (int j = 0; j < i; j++) {
            for (int l = 0; l < contJogos; l++) {

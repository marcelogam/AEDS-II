...
public class FilaSequencial {
    ...
    public FilaSequencial(int tamanho) {
        this.array = new FilaSequencial[5 + 1];
    ...
    public FilaSequencial(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, FilaSequencial jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, FilaSequencial jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, FilaSequencial jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public void inserir(FilaSequencial game, FilaSequencial list) throws Exception {
    ...
    public FilaSequencial remover() throws Exception {
        ...
        FilaSequencial resp = array[primeiro];
        primeiro = (primeiro + 1) % array.length;
        return resp;
    }

    public FilaSequencial descobrirJogo(int id, FilaSequencial jogos[], int contJogos) {
        FilaSequencial game = new FilaSequencial();
    ...
    public void indicarMet(String str, FilaSequencial list, FilaSequencial jogos[], int contJogos) throws Exception {
        ...
        if (str.charAt(0) == 'I') {
            ...
            list.inserir(descobrirJogo(converterStringParaInt(id), jogos, contJogos), list);
            MyIO.println(str);
            MyIO.println(list.mediaAvg());
    ...
    public int mediaAvg() {
        ...
        float soma = 0;
        int i = 0;
        // MyIO.println("p: " + primeiro + " u: " + ultimo);
        int j = primeiro;
            while (j != ultimo) {
                soma += array[j].getAvg_pt();
                j = (j + 1) % array.length;
                i++;
            }
        if (i == 0) { 
    ...
    public static void main(String[] args) throws Exception {
        ...
        FilaSequencial jogos[] = new FilaSequencial[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new FilaSequencial();
        ...
        FilaSequencial list = new FilaSequencial(5);
        int media = 0;
        for (int j = 0; j < i; j++) {
            for (int l = 0; l < contJogos; l++) {
                if (converterStringParaInt(val[j]) == jogos[l].getApp_id()) {
                    list.inserir(jogos[l], list);
                    l = contJogos;
                    media = list.mediaAvg();

...
public class ListaSequencial {
    ...
    public ListaSequencial(int tamanho) {
        this.array = new ListaSequencial[tamanho];
        this.n = 0;
    }
    ...
    public ListaSequencial(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, ListaSequencial jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, ListaSequencial jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, ListaSequencial jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public void inserirInicio(ListaSequencial game) throws Exception {
    ...
    public void inserirFim(ListaSequencial game) throws Exception {
    ...
    public void inserir(ListaSequencial game, int pos) throws Exception {
    ...
    public ListaSequencial removerInicio() throws Exception {
    ...
    public ListaSequencial removerFim() throws Exception {
    ...
    public ListaSequencial remover(int pos) throws Exception {
        ...
        ListaSequencial game = array[pos];
        n--;
    ...
    public ListaSequencial descobrirJogo(int id, ListaSequencial jogos[], int contJogos) {
        ListaSequencial game = new ListaSequencial();
    ...
    public void indicarMet(String str, ListaSequencial list, ListaSequencial jogos[], int contJogos) throws Exception {
        int tamanho = str.length();
        String id = "";
        String posicao = "";
        ListaSequencial game;
    ...
    public static void main(String[] args) throws Exception {
        ...
        ListaSequencial jogos[] = new ListaSequencial[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new ListaSequencial();
        ...
        ListaSequencial list = new ListaSequencial(i + 20);
        for (int j = 0; j < i; j++) {
            for (int l = 0; l < contJogos; l++) {
        ...
        for (int j = 0; j < contMetodos; j++) {
            entrada[i] = MyIO.readLine();
            list.indicarMet(entrada[i], list, jogos, contJogos);
        }

...
public class Games {
    ...
    // Metodo read string
    public void read(String str, Games jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, Games jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, Games jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public static int descobrirIdGame(String str, int cont, Games jogos[]) {
        int id = 0;

...
public class PilhaSequencial {
    ...
    public PilhaSequencial(int tamanho) {
        this.array = new PilhaSequencial[tamanho];
        this.n = 0;
    }
    ...
    public PilhaSequencial(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, PilhaSequencial jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, PilhaSequencial jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, PilhaSequencial jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public void inserirFim(PilhaSequencial game) throws Exception {
    ...
    //Metodo de remover no fim da lista
    
    public PilhaSequencial removerFim() throws Exception {
    ...
    public PilhaSequencial descobrirJogo(int id, PilhaSequencial jogos[], int contJogos) {
        PilhaSequencial game = new PilhaSequencial();
    ...
    public void indicarMet(String str, PilhaSequencial list, PilhaSequencial jogos[], int contJogos) throws Exception {
        int tamanho = str.length();
        String id = "";
        PilhaSequencial game;
        if (str.charAt(0) == 'I') {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PilhaSequencial jogos[] = new PilhaSequencial[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new PilhaSequencial();
        ...
        PilhaSequencial list = new PilhaSequencial(i + 20);
        for (int j = 0; j < i; j++) {
            for (int l = 0; l < contJogos; l++) {

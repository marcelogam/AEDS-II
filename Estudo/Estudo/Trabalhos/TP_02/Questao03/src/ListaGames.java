...
public class ListaGames {
    ...
    public ListaGames(int tamanho) {
        this.array = new ListaGames[tamanho];
        this.n = 0;
    }
    ...
    public ListaGames(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, ListaGames jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, ListaGames jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, ListaGames jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public static int descobrirIdGame(String str, int cont, ListaGames jogos[]) {
        int id = 0;
    ...
    public void inserirFim(ListaGames game) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        long end;
        BufferedWriter arq = new BufferedWriter(new FileWriter("matrícula_sequencial.txt"));
        ...
        ListaGames jogos[] = new ListaGames[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new ListaGames();
        ...
        ListaGames list = new ListaGames(i);

...
public class ListaQuickSort {
    ...
    // Contrutor da lista
    public ListaQuickSort(int tamanho) {
        this.array = new ListaQuickSort[tamanho];
        this.n = 0;
    }

    // Construtor
    public ListaQuickSort() {
        this.app_id = 0;
        this.name = "";
    ...
    public ListaQuickSort(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, ListaQuickSort jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, ListaQuickSort jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, ListaQuickSort jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public void inserirInicio(ListaQuickSort game) throws Exception {
    ...
    public void inserirFim(ListaQuickSort game) throws Exception {
    ...
    public void inserir(ListaQuickSort game, int pos) throws Exception {
    ...
    public ListaQuickSort removerInicio() throws Exception {
    ...
    public ListaQuickSort removerFim() throws Exception {
    ...
    public ListaQuickSort remover(int pos) throws Exception {
    ...
    public ListaQuickSort descobrirJogo(int id, ListaQuickSort jogos[], int contJogos) {
        ListaQuickSort game = new ListaQuickSort();
    ...
    private void quicksort(int esq, int dir) {
        int i = esq, j = dir;
        Date pivo = array[(dir + esq) / 2].getRelease_date();
        while (i <= j) {
            while (array[i].getRelease_date().compareTo(pivo) < 0)
                i++;
            while (array[j].getRelease_date().compareTo(pivo) > 0)
                j--;
            if (i <= j) {
                swap(i, j);
                i++;
    ...
    public static void main(String[] args) throws Exception {
        ...
        ListaQuickSort jogos[] = new ListaQuickSort[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new ListaQuickSort();
        ...
        ListaQuickSort list = new ListaQuickSort(i);
        for (int j = 0; j < i; j++) {
            for (int l = 0; l < contJogos; l++) {

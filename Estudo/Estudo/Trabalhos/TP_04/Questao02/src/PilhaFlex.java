...
class Celula {
	public PilhaFlex list; // Elemento inserido na celula.
	public Celula prox; // Aponta a celula prox.

    public Celula(){
        PilhaFlex list = new PilhaFlex();
        this.list = list;
        this.prox = null;
    }

	public Celula(PilhaFlex list) {
      this.list = list;
      this.prox = null;
	}
}
...
class Pilha {
	...
	public void inserir(PilhaFlex game) {
...
public class PilhaFlex {
    ...
    public PilhaFlex(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, PilhaFlex jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, PilhaFlex jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, PilhaFlex jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public static PilhaFlex descobrirJogo(int id, PilhaFlex jogos[], int contJogos) {
        PilhaFlex game = new PilhaFlex();
    ...
    public static void indicarMet(String str, Pilha list, PilhaFlex jogos[], int contJogos) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PilhaFlex jogos[] = new PilhaFlex[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new PilhaFlex();

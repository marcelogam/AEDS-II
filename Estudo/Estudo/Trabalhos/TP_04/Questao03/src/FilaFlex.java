...
class Celula {
	public FilaFlex list; 
	public Celula prox; 

    public Celula(){
        FilaFlex list = new FilaFlex();
        this.list = list;
        this.prox = null;
    }

	public Celula(FilaFlex list) {
      this.list = list;
      this.prox = null;
	}
}
...
class Fila {
	...
	public void inserir(FilaFlex game) throws Exception {
        if ( n < 5){
	...
	public String remover() throws Exception {
		...
		primeiro = primeiro.prox;
        ultimo.prox = primeiro;
		String resp = primeiro.list.getName();
        n--;
		return resp;
	}
	...
	public void mostrar() {
		int j = 0;
		for(Celula i = primeiro.prox; i != null && i != primeiro; i = i.prox,j++) {
    ...
    public int mediaAvg() {
        ...
        int j = 0;
        while (i != null && i != primeiro) {
            soma += i.list.getAvg_pt();
            j++;
            i = i.prox;
        }
        media = soma / j;
...
class FilaFlex {
    ...
    public FilaFlex(int app_id, String name, Date release_date, String owners, int age, float price, int dlcs,
    ...
    // Metodo read string
    public void read(String str, FilaFlex jogos[], int cont) throws Exception {
        int i = 0;
    ...
    public static String[] converterStringParaArray1(String str, FilaFlex jogos[], int cont) {
    ...
    public static String[] converterStringParaArray2(String str, FilaFlex jogos[], int cont) {
        String array[] = new String[50];
        int j = 0;
        if (str == null) {
            array[0] = "null";
    ...
    public static FilaFlex descobrirJogo(int id, FilaFlex jogos[], int contJogos) {
        FilaFlex game = new FilaFlex();
    ...
    public static void indicarMet(String str, Fila list, FilaFlex jogos[], int contJogos) throws Exception {
        ...
        if (str.charAt(0) == 'I') {
            ...
            list.inserir(descobrirJogo(converterStringParaInt(id), jogos, contJogos));
            MyIO.println(str);
            MyIO.println(list.mediaAvg());
        } else if (str.charAt(0) == 'R') {
            game = list.remover();
            MyIO.println(str);
            System.out.println("(R) " + game);
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        FilaFlex jogos[] = new FilaFlex[4500];
        String line = "";
        line = br.readLine();
        while (line != null) {
            jogos[i] = new FilaFlex();
